class Reindexer < Formula
  ...
  url "https://github.com/Restream/reindexer/archive/v2.7.0.zip"
  version "2.7.0"
  sha256 "85444f1551a4193e035f8b1c9b35be8e429b4065d23f8b02195c807f77ce1847"
  ...
  bottle do
    ...
    cellar :any
    sha256 "da34520e9d31a3f030c698ff329eb4b95ac0e62db6d36e67d4d339b9d9a17b32" => :mojave
  end
  def caveats; <<-EOS
