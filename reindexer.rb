class Reindexer < Formula
  ...
  url "https://github.com/Restream/reindexer/archive/v2.13.0.zip"
  version "2.13.0"
  sha256 "c4b1246618f405eb20c0425cde496c7c4dddd714b90e847efa762d3c93744f2f"
  ...
  bottle do
    ...
    cellar :any
    sha256 "a191cb10938837d7cec17fac3b2f426b6659f5d61c9388121189a0922a12e3c3" => :mojave
  end
  def caveats; <<-EOS
